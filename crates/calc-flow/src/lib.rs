...
pub use operator::{
    ...
    StreamCollector, StreamJoinOperator, StreamJoinSpec, StreamJoinType, StreamOperator,
    StreamOperatorContext, StreamOperatorFactory, UnionOperator, WindowAggregateOperator,
