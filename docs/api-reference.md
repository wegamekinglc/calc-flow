...
runtime; it is not accepted by a public source-driven runner. The public v2
`MicroBatchRunner` and `StreamingRunner` remain unchanged. Public source-driven
integration and durable restart are not available.
