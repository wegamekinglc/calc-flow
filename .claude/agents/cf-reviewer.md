...
unchanged passing checks. Full regression gates belong to regular CI; routine
benchmarks run in the separate twice-daily scheduled workflow. The complete commands,
combined Rust 90% line gate, and Studio 85% floor remain in
...
checks permit a review handoff, not a green or merge-ready claim. Required test,
coverage, and cross-platform failures remain merge blockers. Record cancelled and
